...
<div align="center">
  ...
  <table>
    <tr>
      <td>
        <!-- BLOG-POST-LIST:START --><div><a href='https://velog.io/@joonchoi/jscode-db-retrospect'>1. 데이터베이스 면접 스터디 회고</a></div><div><a href='https://velog.io/@joonchoi/db-recovery'>2. [DB] 데이터베이스 회복</a></div><div><a href='https://velog.io/@joonchoi/db-transaction'>3. [DB] 트랜잭션</a></div><div><a href='https://velog.io/@joonchoi/data-strucuture'>4. [자료구조] 자료구조 개념</a></div><div><a href='https://velog.io/@joonchoi/db-normalization'>5. [DB] 정규화 &lpar;Normalization&rpar;</a></div><!-- BLOG-POST-LIST:END -->
      </td>
    </tr>
  </table>
</div>
