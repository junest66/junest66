...
<div align="center">
  ...
  <table>
    <tr>
      <td>
        <!-- BLOG-POST-LIST:START --><div><a href='https://velog.io/@joonchoi/devops-service'>1. [DevOps] 서비스&lpar;Service&rpar;</a></div><div><a href='https://velog.io/@joonchoi/devops-deployment'>2. [DevOps] 디플로이먼트 &lpar;Deployment&rpar;</a></div><div><a href='https://velog.io/@joonchoi/devops-k8s-command'>3. [DevOps] 쿠버네티스 명령어 모음</a></div><div><a href='https://velog.io/@joonchoi/devops-backend-pod'>4. [DevOps] 백엔드&lpar;Spring&rpar; 서버를 파드로 띄우기</a></div><div><a href='https://velog.io/@joonchoi/devops-pod'>5. [DevOps] 파드&lpar;Pod&rpar;</a></div><!-- BLOG-POST-LIST:END -->
      </td>
    </tr>
  </table>
</div>
